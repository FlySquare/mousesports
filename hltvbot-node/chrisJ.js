...
HLTV.getPlayerByName({name: "chrisJ"}).then(res => {
    ...
    var instagram = "https://www.instagram.com/chrisjcsgo_/";
    ...
    connection5.connect();
    var sqlSorgusu5 = `UPDATE chrisj SET isim = '`+isim+`', nick = '`+nick+`', profilefoto = '`+profilefoto+`', age = '`+age+`',
    ...
    connection5.query(sqlSorgusu5, function (error5, results, fields) {
      ...
      console.log('chrisJ bilgileri Güncellendi');
    });
