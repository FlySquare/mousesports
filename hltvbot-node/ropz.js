...
HLTV.getPlayerByName({name: "ropz"}).then(res => {
    ...
    var instagram = "https://www.instagram.com/ropzicle/";
    ...
    connection5.connect();
    var sqlSorgusu5 = `UPDATE ropz SET isim = '`+isim+`', nick = '`+nick+`', profilefoto = '`+profilefoto+`', age = '`+age+`',
    ...
    connection5.query(sqlSorgusu5, function (error5, results, fields) {
      ...
      console.log('Ropz bilgileri Güncellendi');
    });
