...
HLTV.getPlayerByName({name: "woxic"}).then(res => {
    ...
    var instagram = "https://instagram.com/woxic";
    ...
    connection5.connect();
    var sqlSorgusu5 = `UPDATE woxic SET isim = '`+isim+`', nick = '`+nick+`', profilefoto = '`+profilefoto+`', age = '`+age+`',
    ...
    connection5.query(sqlSorgusu5, function (error5, results, fields) {
      ...
      console.log('Woxic bilgileri Güncellendi');
    });
