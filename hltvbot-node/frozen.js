...
HLTV.getPlayerByName({name: "frozen"}).then(res => {
    
    var isim=res.name;
    var nick=res.ign;
    var profilefoto=res.image;
    var age=res.age;
    var twitter="https://twitter.com/FROZENNcs";
    var facebook="https://www.facebook.com/theofficialfrozen/";
    var twitch=res.twitch;
    var country=res.country.name;
    var instagram = "https://www.instagram.com/callmefrozen/";
    ...
    connection5.connect();
    var sqlSorgusu5 = `UPDATE frozen SET isim = '`+isim+`', nick = '`+nick+`', profilefoto = '`+profilefoto+`', age = '`+age+`',
    ...
    connection5.query(sqlSorgusu5, function (error5, results, fields) {
      ...
      console.log('Frozen bilgileri Güncellendi');
    });
